...
public class OVRGrabber : MonoBehaviour
{
    ...
    public System.Action<OVRGrabbable> OnGrabBegin;
    public System.Action<OVRGrabbable> OnGrabEnd;
    ...
    protected virtual void GrabBegin()
    {
        ...
        if (closestGrabbable != null)
        {
            ...
            _audioSource.PlayOneShot(GrabPBAC);
            OnGrabBegin?.Invoke(m_grabbedObj);
